...
const MoreProduct = () => {
  ...
  useEffect(() => {
    axiosInstance.get('/products/related/' + params.product_id).then((res) => {
  ...
  return (
    <div>
      <div className='more-prod-fulldiv'>
                ...
                <Slider ref={sliderRef} {...settingstwo}>
                  {
                    ...
                    products.map((item, i) => (
                      <div>
                        <div className='single-toy-single'>
                          <div className='produc-toy-img-div'>
                            <img className='produc-toy-img' src={item.thumbnail_image} alt='' />
                          </div>
