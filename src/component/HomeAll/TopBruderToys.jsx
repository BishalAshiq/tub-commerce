              ...
              <Slider ref={sliderRef} {...settingsTwo}>
                ...
                <div className='Top-single-toy'>
                  <div className='tbrudal-img-div'>
                    <img className='categories-img' src={Dolls1.src} alt='' />
                  </div>
                ...
                <div className='Top-single-toy'>
                  <div className='tbrudal-img-div'>
                    <img className='categories-img' src={Dolls3.src} alt='' />
                  </div>
                  <div className='card-t-div'>
                ...
                <div className='Top-single-toy'>
                  <div className='tbrudal-img-div'>
                    <img className='categories-img' src={Dolls4.src} alt='' />
                  </div>
                  <div className='card-t-div'>
                    <span className='card-text'>It is a long established</span>
                    <span className='card-text-rating'>
                ...
                <div className='Top-single-toy'>
                  <div className='tbrudal-img-div'>
                    <img className='categories-img' src={Dolls5.src} alt='' />
                  </div>
                  <div className='card-t-div'>
                    <span className='card-text'>It is a long established</span>
                    <span className='card-text-rating'>
              ...
              <div className='row'>
                <div className='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 '>
                  ...
                  <p className='ong-estab-text'>
                    Bring your products and services to the world. Get started
                    with selling on one channel and expand.
                  </p>
